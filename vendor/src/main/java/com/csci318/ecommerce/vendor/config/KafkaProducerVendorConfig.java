...
@Configuration
public class KafkaProducerVendorConfig {

    @Bean
    public ProducerFactory<Long, RatingReceivedEvent> ratingProducerFactory() {
    ...
    @Bean
    public KafkaTemplate<Long, RatingReceivedEvent> ratingKafkaTemplate() {
